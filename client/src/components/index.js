import CategoryListComp from './layout/CategoryList.vue'
import GnbComp from './layout/Gnb.vue'
...
export const CategoryList = CategoryListComp
export const Pagination = PaginationComp
export const ReviewList = ReviewListComp
export const WriteReview = WriteReviewComp
